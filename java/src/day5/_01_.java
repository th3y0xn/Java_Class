...
//	 * equals() : 대소문자 구분
//	 * if(변수명 == "yes") <-- 문자열 비교할때 이거 안됨!!
//	 * */
//	
//	Scanner studentJoin = new Scanner(System.in);
//	String student = studentJoin.next();
//	System.out.println("출석 여부(Yes/No) : ");
//	
//	if(studentJoin.equalsignoreCase("yes")){
//		System.out.println("과제 제출 여부(Yes/No) : ");
//		String workNum = studentJoin.next();
//		if(workNum.equalsIgnoreCase("yes")) {
//			System.out.println("과제 제출 완료! 수업 100% 참여 인정");
//		}else {
//			System.out.println("과제를 제출하지 않아 50% 출석 인정");
//		}
//	}else {
//		System.out.println("출석 평가 점수 3점 감점");
//	}
//		
//	
//	
