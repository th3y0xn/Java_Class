...
public class _01_operater {
	...
	public static void main(String[] args) {
		 ...
		 * 			변수++; 또는 ++변수;
		 * 	  변수++와 ++변수의 차이?
		 * 	  변수 ++ : 먼저 a의 값이 대입된 후에 ++증가가 실행됨 (후자연산)
		 *    ++ 변수 : a의 값이 먼저 증가한 후에 대입됨 (전자연산)
		 * 
		 * 3. 대입 연산자
		 * 	  a = b : b의 값을 a에 대입
		 *    a += b : a = a + b
		 ...
		 *    
		 * 5. 논리연산자
		 *    	&&(and) : 그리고~ 라는 뜻으로 조건식이 모드 참일때만 참을 반환
		 *    	||(or) : 조건식 중 하나라도 참이면 참을 반환
		 *    	|(not) : 결과값의 반대를 출력함 ( 값이 true라면 false를 출력함 )
		 * 
		 * 6. 삼형조건연산자
		 * 		조건식이 true라면 식1을 실행 / false라면 식2를 실행
		 * 		조건식 ? 식1 : 식2;
		 **/
